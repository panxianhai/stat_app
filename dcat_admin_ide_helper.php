...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection click_type
     ...
     * @method Grid\Column|Collection click_type(string $label = null)
     ...
     * @property Show\Field|Collection click_type
     ...
     * @method Show\Field|Collection click_type(string $label = null)
